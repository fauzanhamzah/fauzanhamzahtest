...
$routes->get('/barang', 'BarangController::index', ['as' => 'barang']);
...
$routes->get('/barang/(:any)', 'BarangController::detail/$1');
$routes->post('/barang/save', 'BarangController::save', ['as' => 'simpan_barang']);
