    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="/barang/update/<?= $barang['id']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="foto_barangLama" value="<?= $barang['foto_barang']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control <?= ($validation->hasError('harga_jual')) ? 'is-invalid' : ''; ?>" id="harga_jual" name="harga_jual" value="<?= (old('harga_jual')) ? old('harga_jual') : $barang['harga_jual']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control <?= ($validation->hasError('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" value="<?= (old('stok')) ? old('stok') : $barang['stok']; ?>">
                ...
                <div class="form-group row">
                    <div class="col-sm-9">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">Update barang</button>
                    </div>
                </div>
            </form>
        </div>
